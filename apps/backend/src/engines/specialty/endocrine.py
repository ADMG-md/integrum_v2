...
class EndocrinePrecisionMotor(BaseClinicalMotor):
    ...
    Evidence:
    - TSH/FT4 classification: ATA Guidelines 2014, Thyroid 24(10): 1-160.
    - FT3/rT3 ratio: Itoh et al., 2019. Endocrine J 66: 1099-1107.
    - SHBG as peripheral tissue marker: Selva et al., 2010. Nat Rev Endocrinol 6: 69-79.
    - Morning cortisol screening: Nieman et al., 2008. JCEM 93(10): 3701-3709.
    ...
    def validate(self, encounter: Encounter) -> Tuple[bool, str]:
        ...
        if not encounter.get_observation(
            self.CODES["TSH"]
        ) and not encounter.get_observation(self.CODES["FT4"]):
