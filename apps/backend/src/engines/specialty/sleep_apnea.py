...
class SleepApneaPrecisionMotor(BaseClinicalMotor):
    ...
    Evidence:
    - Chung et al., 2008. Anesthesiology 108(5): 812-821. doi: 10.1097/ALN.0b013e31816d83e4.
      STOP-Bang questionnaire development and validation. Score >= 3 = high risk.
      Sensitivity 93% for moderate-severe OSA (AHI >= 15).
    - Chung et al., 2012. Br J Anaesth 108(2): 280-286.
      STOP-Bang in surgical patients: score >= 5 = very high risk.
    - Nagappa et al., 2015. Sleep Med Rev 24: 1-10.
      Systematic review: STOP-Bang is the most validated OSA screening tool.
    - Athens Insomnia Scale: Soldatos et al., 2000. J Psychosom Res 49: 29-35.
    ...
    def compute(self, encounter: Encounter) -> AdjudicationResult:
        ...
        if s_obs and s_obs.value in [1, True, "Yes", "Si"]:
            ...
            evidence.append(
                ClinicalEvidence(
                    type="Lifestyle", code="STOP-S", value="Yes", display="Ronca fuerte"
                )
            )
        ...
        # Risk Stratification
        if score >= 5:
            risk = "Riesgo Alto de OSA"
        elif score >= 3:
            risk = "Riesgo Intermedio de OSA"
        else:
            risk = "Riesgo Bajo de OSA"
        ...
        return AdjudicationResult(
            ...
            + (
                "Se recomienda estudio de sueño (Polisomnografía) por riesgo elevado."
                if score >= 3
                else "Bajo riesgo de apnea obstructiva del sueño."
            ),
        )
